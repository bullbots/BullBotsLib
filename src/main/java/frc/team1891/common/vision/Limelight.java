...
public class Limelight {
    ...
    private static final NetworkTableInstance tableInstance = NetworkTableInstance.getDefault();
    private static final NetworkTable table = tableInstance.getTable("limelight");

    // Toggle for posting to SmartDashboard
    public static final boolean POST_TO_SMART_DASHBOARD = false;

    // Uses network tables to check status of limelight
    private static final NetworkTableEntry timingTestEntry = table.getEntry("TIMING_TEST_ENTRY");
...
//        timingTestEntry.forceSetBoolean(timingTestEntryValue);
    ...
    private static final NetworkTableEntry validTargetEntry = table.getEntry("tv");
    ...
    private static final NetworkTableEntry xAngleEntry = table.getEntry("tx");
    ...
    private static final NetworkTableEntry yAngleEntry = table.getEntry("ty");
    ...
    private static final NetworkTableEntry targetAreaEntry = table.getEntry("ta");
    ...
    private static final NetworkTableEntry targetSkewEntry = table.getEntry("ts");
    ...
    private static final NetworkTableEntry latencyEntry = table.getEntry("tl");
    ...
    private static final NetworkTableEntry shortestSideLengthEntry = table.getEntry("tshort");
    ...
    private static final NetworkTableEntry longestSideLengthEntry = table.getEntry("tlong");
    ...
    private static final NetworkTableEntry horizontalSideLengthEntry = table.getEntry("thor");
    ...
    private static final NetworkTableEntry verticalSideLengthEntry = table.getEntry("tvert");
    ...
    private static final NetworkTableEntry LEDModeEntry = table.getEntry("ledMode");
    ...
    private static final NetworkTableEntry camModeEntry = table.getEntry("camMode");
    ...
    // PIPELINE
    private static final NetworkTableEntry pipelineEntry = table.getEntry("pipeline");
    ...
    private static final NetworkTableEntry getPipelineEntry = table.getEntry("getpipe");
    ...
    private static final NetworkTableEntry CameraStreamEntry = table.getEntry("stream");
    ...
    private static final NetworkTableEntry SnapshotModeEntry = table.getEntry("snapshot");
